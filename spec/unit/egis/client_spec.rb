...
RSpec.describe Egis::Client do
  ...
  describe '#query_status' do
    ...
    it 'returns query output location' do
      expected_output = Egis::QueryOutputLocation.new(
  ...
  describe '#database' do
    ...
    it { is_expected.to be_a(Egis::Database) }
  end
  ...
  describe '#execute_query' do
    ...
    context 'when async true' do
      ...
      it 'return query status object with proper id' do
        ...
        expect(query_status).to be_a(Egis::QueryStatus)
    ...
    context 'when async false' do
      ...
      context 'when get_query_execution returns FAILED at first time' do
        ...
        it 'executes Athena query, waits for result' do
          ...
          expect { subject }.to raise_error(Egis::Errors::QueryExecutionError)
        end
      end
